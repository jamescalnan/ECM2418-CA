...
%combine_acc(+Indices, +Grid, -Sum, Accumulator)
...
suko( T0, T1, T2, T3, US, U, VS, V, WS, W, GRID) :-
    possible(GRID),
    %Check if GRID is a permutation of [1, 2, 3, 4, 5, 6, 7, 8, 9]
    acceptable( T0, T1, T2, T3, US, U, VS, V, WS, W, GRID).
    %Checking if results meet the criteria of US, VS, WS and U, V, W
